...
public class BinarySearchTree<T extends Comparable<T>> {
    ...
    public List<T> getByTraversal(TraversalType type) {
        ...
        return switch (type) {
            case TraversalType.PREORDER ->  preorderRecursive();
            case TraversalType.INORDER ->  inorderRecursive();
            case TraversalType.POSTORDER ->  postorderRecursive();
            case TraversalType.LEVEL_ORDER ->   levelOrder();
        };
    }
}
